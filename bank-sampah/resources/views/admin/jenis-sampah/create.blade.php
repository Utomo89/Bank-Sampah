    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Tambah Jenis Sampah</h1>
                <p class="text-gray-600 mt-2">Tambahkan jenis sampah baru beserta harga per kilogramnya</p>
            </div>
